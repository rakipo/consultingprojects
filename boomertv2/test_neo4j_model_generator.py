...
from neo4j_model_generator import (
...
class TestNeo4jModelGenerator(unittest.TestCase):
    ...
    def test_generate_timestamp_error_handling(self):
        ...
        with patch('neo4j_model_generator.datetime') as mock_datetime:
    ...
    @patch('neo4j_model_generator.get_query_from_config')
    @patch('neo4j_model_generator.parse_postgres_config')
    @patch('neo4j_model_generator.load_config')
