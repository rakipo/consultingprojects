...
class TestNeo4jDataLoader(unittest.TestCase):
    ...
    @patch('neo4j_data_loader.SentenceTransformer')
    ...
    @patch('neo4j_data_loader.get_query_from_config')
    @patch('neo4j_data_loader.parse_postgres_config')
    @patch('neo4j_data_loader.load_config')
