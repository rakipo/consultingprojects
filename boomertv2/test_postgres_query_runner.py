...
class TestPostgresQueryRunner(unittest.TestCase):
    ...
    @patch('postgres_query_runner.write_results_to_file')
    @patch('postgres_query_runner.execute_query')
    @patch('postgres_query_runner.get_db_connection')
    @patch('postgres_query_runner.load_config')
